...
tags: [ctf,web]
---
We played irisctf as Ireland Without the RE and finished in 19th position. This writeup will only include web challenges. We managed to full clear the web category so this will cover all of them.

# web/Password Manager (355 Solves)
